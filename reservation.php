...
<div class="container-form">
    ...
    <form action="" method="post">
        ...
        <br>
        <br>
        <label>Check In</label><input type="date" id="cin"  name="cin" min="2021-11-04" required>
        <label>Check Out</label><input type="date" id="cout" name="cout" min="2021-11-05" required>
        <br>
        <br>
        <br>
        ...
        <br>
        <br>
        <input style="margin-left: 45%;" class="submit-btn" type="submit" name="submit" id="submit">
        </fieldset>
